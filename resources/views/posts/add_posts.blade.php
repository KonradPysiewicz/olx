...
<div class='container'>
<h1><p class="font-weight-bold mt-4 mb-4">Dodaj ogłoszenie</p></h1>
</div>
            ...
            <form action="{{route('add_post')}}" method="post" enctype="multipart/form-data">
              @csrf
                ...
                <p class="font-weight-bold">Im więcej szczegółów, tym lepiej!</p>
                  ...
                  <input type="text" class="form-control mb-3  @error('tytul') border border-danger @enderror" id="tytul" name="tytul"  aria-describedby="emailHelp" placeholder="np. iPhone 11 na gwarancji">
                  ...
                  <input type="text" class="form-control mb-3" id="cena" name="cena"  aria-describedby="emailHelp" value="Za darmo">
                    ...
                    <select class="custom-select" id="lokalizacja" name="lokalizacja">
                      ...
                      <option value="Zachodniopomorskie">Zachodniopomorskie</option>
                        ...
                        <div class="form-group">
                          ...
                          <button class="btn border-primary" type="submit">Dodaj ogłoszenie</button>
                    </div>
                  </form>
                </div>
                  </div>
